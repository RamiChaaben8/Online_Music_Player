...
// theming, use AppThemeScope.of(context).<field> instead.
// ============================================================
...
// Live widgets should prefer AppThemeScope.of(context) for dynamic colours.
...
// ─── Convenience extension — read live theme from context ────────────────────

extension ThemeContext on BuildContext {
  AppThemeData get appTheme => AppThemeScope.of(this);
  Color get themeAccent      => AppThemeScope.of(this).accent;
  Color get themeBg          => AppThemeScope.of(this).bgColor;
  Color get themePanel       => AppThemeScope.of(this).panelColor;
  Color get themeCard        => AppThemeScope.of(this).cardColor;
}
